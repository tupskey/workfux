                                ...
                                <div className="wt-completejobholder">
                                    ...
                                    <div className="wt-managejobcontent">
                                        ...
                                        <div className="wt-userlistinghold wt-featured wt-userlistingvtwo">
                                            <span className="wt-featuredtag"><img src={process.env.PUBLIC_URL + 'assets/images/featured.png'} alt="img description" data-tipso="Plus Member" className="template-content tipso_style mCS_img_loaded" /></span>
